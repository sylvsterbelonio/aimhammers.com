...
<script>
$(function(){$("#cmdMyContact").click(function(){var position = $(this).position(); $("#myinfo").fadeIn(500);});$("#cmdWishList").click(function(){$("#myinfo2").fadeIn(500);});
$(document).mouseup(function (e){  var container = $("#myinfo,#myinfo2");  
if (!container.is(e.target)       && container.has(e.target).length === 0)   {  container.fadeOut(300);    }});});
</script>            
