...
;( function( window ) {
	...
	Modernizr2.addTest('csstransformspreserve3d', function () {
		var prop = Modernizr2.prefixed('transformStyle');
		var val = 'preserve-3d';
		var computedStyle;
		...
		Modernizr2.testStyles('#modernizr2{' + prop + ':' + val + ';}', function (el, rule) {
	...
	var support = { 
			animations : Modernizr2.cssanimations,
			preserve3d : Modernizr2.csstransformspreserve3d,
			transforms3d : Modernizr2.csstransforms3d
		},
		...
		animEndEventName = animEndEventNames[ Modernizr2.prefixed( 'animation' ) ];
  ...
  //window.setInterval(function() {
    ...
    //}
		 	...
		 	//TiltSlider._showItem( selectedItems );
			//autoplaymode();
